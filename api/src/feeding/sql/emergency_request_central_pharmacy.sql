...
SELECT 
                    cd_atendimento
                   ,cd_solsai_pro
                  ,To_Char(DT_SOLSAI_PRO, 'DD/MM/RRRR') DT_SOLSAI_PRO
                  ,ds_leito
                ...
                ,To_Char(dt_nascimento, 'DD/MM/RRRR') dt_nascimento
                  ,(CASE WHEN tp_situacao = 'P'  AND TEMPO  >  '00:15:00' THEN ('VERMELHO')
                          WHEN tp_situacao = 'C'  AND TEMPO  >= '00:15:00' THEN ('AMARELO')
                            END) AS COR  
                FROM (
                SELECT
                  ...
                  FROM  SOLSAI_PRO,ITSOLSAI_PRO, atendime, paciente , leito   
                    WHERE  To_date(SOLSAI_PRO.hr_solsai_pro,'dd/mm/yyyy hh24:mi:ss') BETWEEN To_Date (SYSDATE,'dd/mm/yyyy hh24:mi:ss')  AND SYSDATE
