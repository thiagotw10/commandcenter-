-- TOTAL ESTOQUE por controle de validade (30 -60 e 90 DIAS) - N PADRÃO 
-- total_stock_by_non_standard_validity_control.sql
-- CRITICO - 0-10
-- ATENCAO - 10.01-20
-- ABASTECIDO- 20.01-40
-- EXCESSO - >40.01
-- USADO COMO BASE RELATORIO -R_CONT_VALID enviado pelo cliente
...
WHERE PRODUTO.CD_SUB_CLA = SUB_CLAS.CD_SUB_CLA
  ...
  AND PRODUTO.SN_PADRONIZADO = 'N' -- PRODUTO N PADRÃO 
