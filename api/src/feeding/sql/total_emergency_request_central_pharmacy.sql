-- total de solicitações urgente atendidas (Mais de 15 min e no horario)
-- Total_emergency_request_central_pharmacy.sql
...
SELECT
 ...
 SELECT
                  ...
                  (CASE WHEN tp_situacao in ('P','S','C')  AND TEMPO  >  '00:15:00' THEN 1
                          WHEN tp_situacao = 'C'  AND TEMPO  >= '00:15:00' THEN 1
                            END) AS TEMP1
                  ,TEMPO
                  ,Count((CASE WHEN tp_situacao in ('P','S','C')  AND TEMPO  <  '00:15:00' THEN 1
                          WHEN tp_situacao = 'C'  AND TEMPO  < '00:15:00' THEN 1
                            END)) AS tempo2
  ...
  SELECT
            distinct solsai_pro.cd_solsai_pro
                  ...
                  FROM  SOLSAI_PRO, atendime, paciente , leito, mvto_estoque
                    ...
                    AND SOLSAI_PRO.sn_urgente in ('S')
